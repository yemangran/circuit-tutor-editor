const en = {
  ...
  panel: {
    ...
    export: {
      ...
      copyCurrent: 'Copy current output',
      exportSuccess: 'The export output was generated and copied to the clipboard.',
      exportError: 'The export output was generated, but copying to the clipboard failed.',
      previewJson: 'JSON preview',
      previewAscii: 'ASCII preview',
      previewJsonHint: 'Structured semantic export for AI reasoning.',
      previewAsciiHint: 'Schematic-style ASCII export derived from semantic nodes and branches.',
